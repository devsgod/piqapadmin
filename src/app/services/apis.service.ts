...
export class ApisService {
  ...
  public getCategories(uuid:string): Promise<any> {
    
    return new Promise<any>((resolve, reject) => {
     
      

      this.adb.collection('categories',ref => ref.where('uid','==',uuid)).get().subscribe((venue: any) => {
        let data = venue.docs.map(element => {
          let item = element.data();
          item.id = element.id;
          return item;
  ...
  public getsingleCategoryByName(id,name): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('categories', ref => ref.where('uid', '==', id).where('name', '==', name)
        ).get().subscribe((venue) => {
  ...
  public getsingleCategory(id): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('categories', ref => ref.where('id', '==', id)).get().subscribe((venue) => {
        var data = venue.docs.map(element => {
          var item = element.data();
          item.id = element.id;
          return item;
...
public getFoodsAll(): Promise<any> {
  return new Promise<any>((resolve, reject) => {
    this.adb.collection('foods').get().subscribe((venue: any) => {
      console.log("%%%%%%%");
      console.log(venue);
      console.log("%%%%%%%");
      let data = venue.docs.map(element => {
...
*/
  ...
  public getFoodsAll(): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('foods').get().subscribe((food) => {
        let data = food.docs.map(element => {
          return element;
        });
        resolve(data);
      }, error => {
...
/*
  public getFoodsAll(): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.db.collection('foods').get().then((data) => {
...
public getFood(id,uuid): Promise<any> {
  return new Promise<any>(async (resolve, reject) => {
    this.adb.collection('foods').doc(uuid).collection('all').doc(id).get().subscribe(async (food: any) => {
      console.log(food); 
      resolve(food);
    }, error => {
      reject(error);
...
*/
  ...
  public getFoods(uid: any): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.db.collection('foods').doc(uid).collection('all').orderBy('name').get().then((data) => {
        var users = data.docs.map(doc => {
          var item = doc.data();
          item.cid.get().then(function (doc) {
            item.cid = doc.data();
  ...
  public getCity(id): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      this.adb.collection('cities', ref => ref.where('id', '==', id)).get().subscribe((venue: any) => {
        let data = venue.docs.map(element => {
          let item = element.data();
          item.id = element.id;
          return item;
  ...
  public createFood(informations: any): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      informations.cid = this.adb.doc('/categories/' + informations.cid).ref;
      this.adb.collection('foods/'+informations.uuid+'/all').add(informations).then((data) => {
  ...
  public updateFood(informations: any): Promise<any> {
    return new Promise<any>((resolve, reject) => {
      informations.cid = this.adb.doc('/categories/' + informations.cid).ref;

            this.adb.collection('foods/'+informations.uuid+'/all').doc(informations.uid).update(informations).then((data) => {
              resolve(data);
            }, error => {
              console.log(error);
              reject(error);
  ...
  public deleteFood(informations: any): Promise<any> {
    console.log("********************");
