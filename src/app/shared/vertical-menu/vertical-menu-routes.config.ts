...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: '/restaurants', title: 'Restaurants', icon: 'ft-book', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  }, 
  {
    path: '/foods', title: 'Foods', icon: 'ft-menu', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  {
    path: '/users', title: 'Users', icon: 'ft-users', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  {
    path: '/orders', title: 'Orders', icon: 'ft-shopping-cart', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  {
    path: '/drivers', title: 'Drivers', icon: 'ft-truck', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  {
    path: '/stats', title: 'Stats', icon: 'ft-trending-up', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  {
    path: '/coupons', title: 'Coupons', icon: 'ft-award', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  {
    path: '/banners', title: 'Banners', icon: 'ft-layers', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
